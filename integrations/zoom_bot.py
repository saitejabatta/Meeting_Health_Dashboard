...
class ZoomBot:
    ...
    def join(self, meeting_url: str) -> JoinResult:
        ...
        zoom_url = _to_zoom_url_scheme(meeting_url)
        try:
            ...
            return JoinResult(True, f"Opened Zoom via URL scheme. Route Zoom audio to {routing.device_name}.{credentials_note}")
